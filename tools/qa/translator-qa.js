(function () {
    ...
    function getGrammarRegressionChecks() {
        return [
            ...
            { id: 'MECH-REVIEW-INFLECTED-ICHIDAN-NEGATIVE', suite: 'engine', rule: 'A non-template sentence uses conjugation evidence to distinguish the uniquely compatible Ichidan stem reading from incompatible whole-verb alternatives', input: '利益を得ない', expected: 'Rieki o Enai', expectedRequiresReview: false },
